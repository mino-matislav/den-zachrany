...
:root {
    ...
    --shadow-medium: rgba(46, 46, 46, 0.12);

    /* Typografia */
    --font-display: 'Playfair Display', Georgia, serif;
    --font-body: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif;
    --font-verse: 'Merriweather', Georgia, serif;
...
.hero {
    ...
    background: linear-gradient(180deg, var(--cream-light) 0%, var(--cream) 40%, var(--blue-gray) 100%);
    overflow: hidden;
    text-align: center;
}
...
.player-progress:focus .progress-thumb {
    opacity: 1;
}
...
/* ============================================
   ...
   ============================================ */
.page-header {
    padding: calc(64px + var(--space-16)) var(--space-6) var(--space-12);
...
.chapter-item.starter {
    background: var(--gold-light);
    border: 2px solid var(--gold);
    order: -1;
}

.chapter-item.starter::before {
    content: '⭐ Štartovacia kapitola';
    display: block;
    font-size: var(--text-xs);
    font-weight: 600;
    color: var(--gold);
...
.chapter-item.last-read::after {
    content: 'Naposledy čítané';
    position: absolute;
    top: -10px;
    right: var(--space-4);
    background: var(--gold);
...
.chapter-link.is-disabled::after {
    content: '⏳';
    transform: none;
}
...
/* ============================================
   ...
   ============================================ */
.chapter-page {
    padding: calc(64px + var(--space-12)) var(--space-6) var(--space-20);
    background: var(--cream);
    min-height: 100vh;
}
...
.chapter-illustration {
    ...
    margin: 0 auto var(--space-10);
    height: 200px;
    background: linear-gradient(135deg, var(--cream-light) 0%, var(--blue-gray) 50%, var(--gold-light) 100%);
    border-radius: var(--radius-lg);
    position: relative;
    overflow: hidden;
}
...
@media (max-width: 768px) {
    ...
    .hero {
        padding: calc(64px + var(--space-12)) var(--space-4) var(--space-16);
    }
